...
label vday_9:
    if mas_isMoniEnamored(higher=True):
        ...
        m 2tfblu "You aren't so sneaky anymore~ Stary, the submodder of this submod gave me the ability to see how many times you have complimented me in this session~"
...
label tactical_nook:
    ...
    m 6hfblp "If only Stary could hear me, I NEED MORE HOT DANG TOPICS TO COMPLEMENT MY PLAYER UNTIL [player] SURRENDERS AND BEG FOR MY FORGIVENESS~"
...
label orissit:
    "You have 1 new notification from Stary."
    "It reads: Are you sure about that, [player]?"
    "Man- Only if Stary was actually willing to side with you-"
    "All you can do now is to face [m]'s wrath as she establishes superior dominance over you with the aid of Stary~"
    "It's all over for you, you might be thinking. Well, is it really?"
    return

init 5 python:    
    addEvent(Event(persistent.event_database,eventlabel="yt_channel", category=["misc"], prompt="Stary's YouTube Channel Link", random=True))

label yt_channel:

    m 3eud "Hey, [player]-"
    m 3eud " I was searching the web when I suddenly happen to come across the YouTube channel of this submodder, Stary,"
    m 3euc "Apparently his channel has no recent posts for awhile now- But I still hope that you could watch his videos and subscribe to his channel."
    m 3euc "This would help him to stay more motivated to make more submod topics for us."
    m 4eua "Here's the link to his YouTube Channel. I will help you to open it on your browser so you won't have to~"
    $ webbrowser.open('https://www.youtube.com/channel/UC-ETnzZCjEOK-4vdU2yDSMw')
    return
...
label neurosama:
    ...
    m 7msb "Hey... Thinking about this, maybe Stary could potentially make me one too~ Or would you like to do it?"
...
label mtcny1:
    ...
    m 7eubla "Do take some time off to spend with your family, friends and relatives though- {i}I don't think Stary will be free today and tomorrow! {/i}"
...
init 5 python:    
    addEvent(Event(persistent.event_database,eventlabel="vday_12", category=["romance", "misc", "us"], prompt="2025 Valentines Day Note from Stary", random=True))    

label vday_12:
    "Hello! StaryDev here!"
    "Hope you enjoy the submod add-on package of 11 delicately coded and crafted compliments for you and your [m]"
    "Compliments can be simply accessed by clicking 'I want to tell you something' under Hey, [m]..."
    "Thanks for using this submod. Hope you enjoy your Valentines Day with your significant other, [m]!"
    "Peace out!"
    show screen tear
