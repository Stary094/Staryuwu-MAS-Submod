...
init 5 python:    
    addEvent(Event(persistent.event_database,eventlabel="oof", category=["misc", "monika"], prompt="Just not [m]?", pool=True, unlocked=True))
...
label ayy:    
    m 4tsb "Can deez' nuts fit in your mouth?"
...
label oofy2:
    ...
    menu:
        ...
        "Oh my god, [m]... Pick a deez nuts joke that's a little less basic than your anime choices, alright?":
        
            jump oofy3
            
label oofy3:
    m 4wud "..."
    m 2gfblp "Hmph... {w=1}I'll get you next time, [player]!"
...
label oofy4:                 
    m 2wubld "..."
    m 1hublb "You got me... I didn't know you were so defensive of yourself by using a meme...hehe~"
    m 1cfbfb "I won't go so easy on you next time though, [player]! So watch out!"
    m 7cfbfb "Or you will be blasted by the light of a thousand suns!"
    m 7hubfb "Ehehehe, just kidding~"
...
init 5 python:
    addEvent(Event(persistent.event_database,eventlabel="xmas1", category=["music"], prompt="Stary's X'mas Recommendation", random=True)) 

label xmas1:
    m 3sub "Hey, [player]! It's finally Christmas!"
    m 3hub "I am so happy to spend my time during Christmas with you!"
    m 3hub "Stary has also helped us to create some Christmas topics!"
    m 3hub "To go along with it, Stary wanted to recommend you a song that you can play while spending time with me!"
    m 3lub "I'll create a option if you want to play the song that he recommended."
    m 3hub "Without further ado, let's spend our Christmas together!"
    return

init 5 python:
    addEvent(Event(persistent.event_database,eventlabel="xmas2", category=["music"], prompt="Xmas Music URL", pool=True, unlocked=True))

label xmas2:
    $ renpy.run(OpenURL("https://www.youtube.com/watch?v=Um77fE__gw8&t=1880s"))
    return

init 5 python:
    addEvent(Event(persistent.event_database,eventlabel="xmas3", category=["mas_compliment"], prompt="[m], won't you guide my sleigh tonight?", unlocked=True), code="CMP")

label xmas3:
    m 3hub "I would love to!"
    m 3hub "Ehehehe~ Let's enjoy the rest of our Christmas together!"
    m 5hublb "I love you!"
    return "love"

init 5 python:
    addEvent(Event(persistent.event_database,eventlabel="xmas4", category=["mas_compliment"], prompt="I love you especially this Christmas!", unlocked=True), code="CMP") 

label xmas4:      
    m 5hubfa "Ehehehe~ I Love you, [player]! <3"
    return "love"

init 5 python:
    addEvent(Event(persistent.event_database,eventlabel="xmas5", category=["mas_compliment"], prompt="I love your Christmas outfit!", unlocked=True), code="CMP") 

label xmas5:
    m 3hub "Thank you!{w=1} It makes me so happy that you do!"
    m 5hublb "I love you so much, [player]! Let's spend the rest of our Christmas together now, shall we?"
    return "love"

init 5 python:
    addEvent(Event(persistent.event_database,eventlabel="xmas6", category=["mas_compliment"], prompt="I love your jolly spirit!", unlocked=True), code="CMP")     

label xmas6:
    m 3hub "Thank you, [mas_get_player_nickname()]! I love your jolly spirit too!"
    m 5hublb "Ehehehehe~ I.L.Y., [player]!"
    return "love"
